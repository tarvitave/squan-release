# Squan v2.0.0 - Universal AI Development Platform

> **Major Release**: Multi-model support, MCP extensions, workflow automation, and smart context management

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Docker](https://img.shields.io/badge/Docker-ghcr.io-blue?logo=docker)](https://ghcr.io/tarvitave/squan)
[![Version](https://img.shields.io/badge/version-2.0.0-green)](https://github.com/tarvitave/squan-release/releases/tag/v2.0.0)
[![Website](https://img.shields.io/badge/website-squan.dev-blue)](https://squan.dev)
...
### Getting Started
- [Installation Guide](https://squan.dev/docs/installation)
- [Quick Start Tutorial](https://squan.dev/docs/quick-start)
- [Configuration Reference](https://squan.dev/docs/configuration)

### Core Features
- [Multi-Model Support](https://squan.dev/docs/multi-model)
- [MCP Extensions Guide](https://squan.dev/docs/extensions)
- [Recipe System](https://squan.dev/docs/recipes)
- [CLI Reference](https://squan.dev/docs/cli-reference)

### Migration & Upgrade
- [v1.x to v2.0 Migration](https://squan.dev/docs/migration-v2)
- [CHANGELOG](https://github.com/tarvitave/squan-release/blob/main/CHANGELOG.md)
...
```bash
# Clone
git clone https://github.com/tarvitave/squan
cd squan
...
See [CONTRIBUTING.md](https://squan.dev/contributing) for guidelines.

---

## 📞 Support

- **Issues**: [GitHub Issues](https://github.com/tarvitave/squan/issues)
- **Discussions**: [GitHub Discussions](https://github.com/tarvitave/squan/discussions)
- **Email**: support@squan.dev
- **Documentation**: https://squan.dev/docs
- **Community**: https://discord.gg/squan
...
**Squan v2.0.0** - Transform your development workflow with AI orchestration

🚀 [Get Started](https://squan.dev/docs/quick-start) • 📖 [Documentation](https://squan.dev/docs) • 💬 [Community](https://discord.gg/squan)

---

<p align="center">
  Built with Claude Code • <a href="https://squan.dev">squan.dev</a>
</p>